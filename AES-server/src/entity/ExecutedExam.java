...
public class ExecutedExam implements Serializable, Comparable {
	...
	public ExecutedExam(String executedExamID, int numOfStudentStarted, int numOfStudentFinished,
			...
			int range0to9, int range10to19, int range20to29, int range30to39, int range40to49, int range50to59,
			String status, int range60to69, int range70to79, int range80to89, int range90to100,
			Time actuallySolutionTime, Date startDate) {
		super();
